import { projects } from "../constants/AboutDetails.contants";
  ...
  return (
    <section className="max-container">
      <h1 className="head-text">
        My{" "}
        <span className="blue-gradient_text font-semibold drop-shadow-2xl">
          Projects
        </span>
      </h1>
            ...
            <div className="lg:w-[400px] w-full" key={project.name}>
                ...
                <div className="mt-5 flex flex-col">
                    ...
                    <div className="mt-5 flex items-center gap-2">
                        ...
                        className="fontsemibold text-blue-600">
                            live Link
                        </Link>
